(function () {
	...
	***************************************************************************** */
	...
	function createErrorFn(errType) {
	    // @ts-ignore
	    return function (fn) { return new Errors[errType](null, fn); };
	}
	Object.defineProperty(window, '%proxyless%', {
	    value: {
	        ...
	        executeSelectorCommand: function (command, selectorTimeout, startTime, returnNode, errTypes) {
	            var createNotFoundError = command.needError ? createErrorFn(errTypes.notFound) : null;
	            var createIsInvisibleError = command.needError ? createErrorFn(errTypes.invisible) : null;
