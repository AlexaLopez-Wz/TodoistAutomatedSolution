...
(function () {
    function initTestCafeClientDrivers(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, Promise$7, testCafeCore, testcafeAutomation, testCafeUI) {
    var hammerhead__default = 'default' in hammerhead ? hammerhead['default'] : hammerhead;
    Promise$7 = Promise$7 && Object.prototype.hasOwnProperty.call(Promise$7, 'default') ? Promise$7['default'] : Promise$7;
    ...
    ***************************************************************************** */
    ...
    function __awaiter(thisArg, _arguments, P, generator) {
        ...
        return new (P || (P = Promise$7))(function (resolve, reject) {
    ...
    function findDraggableElement(element) {
        ...
        while (parentNode) {
            if (parentNode.draggable)
                return parentNode;
            parentNode = nativeMethods$5.nodeParentNodeGetter.call(parentNode);
        }
        return null;
    }
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.prototype._movingStep = function () {
            ...
            if (this.touchMode && !this.holdLeftButton) {
                ...
                this.startTime = nativeMethods$5.dateNow();
                ...
                var currentTime = Math.min(nativeMethods$5.dateNow(), this.endTime);
            ...
            return underCursor()
                ...
                if (draggable && featureDetection.hasDataTransfer && !_this.skipDefaultDragBehavior) {
                    ...
                    if (isLink || domUtils$2.isImgElement(_this.dragElement)) {
                        ...
                        var outerHTML = htmlUtils.cleanUpHtml(nativeMethods$5.elementOuterHTMLGetter.call(_this.dragElement));
    ...
    function executeChildWindowDriverLinkSelector(selector, childWindowLinks) {
        if (typeof selector === 'string') {
            ...
            return Promise$5.resolve(foundChildWindowDriverLink);
        }
        // TODO:  Query url and title properties of the all driverLinks' windows
        return Promise$5.resolve(null);
    }
    ...
    var DateCtor$2 = nativeMethods$6.date;
    ...
    var Driver = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise$6.all(searchQueries)];
                        case 1:
        ...
        Driver.prototype._getCloseWindowFoundResult = function () {
            ...
            return Promise$6.resolve({ success: true });
        };
        ...
        Driver.prototype._closeWindow = function (msg) {
            ...
            return Promise$6.all(searchQueries);
        };
        ...
        Driver.prototype._switchToWindow = function (msg) {
            ...
            if (!this.childWindowDriverLinks.length)
                return Promise$6.resolve();
            return Promise$6.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
        ...
        Driver.prototype._handleChildWindowIsOpenedInIFrame = function () {
            ...
            this._pendingChildWindowInIFrame = new Promise$6(function (resolve) {
        ...
        Driver.prototype._runInActiveIframe = function (command) {
            var _this = this;
            var runningChain = Promise$6.resolve();
        ...
        Driver.prototype._switchToIframe = function (selector, iframeErrorCtors) {
            ...
            return getResult(selector, commandSelectorTimeout, null, function (fn) { return new iframeErrorCtors.NotFoundError(null, fn); }, function () { return new iframeErrorCtors.IsInvisibleError(); }, this.statusBar)
                ...
                return _this._ensureChildIframeDriverLink(nativeMethods$6.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, commandSelectorTimeout);
            })
        ...
        Driver.prototype._createWaitForEventPromise = function (eventName, timeout) {
            ...
            var timeoutPromise = new Promise$6(function (resolve) {
                nativeMethods$6.setTimeout.call(window, function () {
                    _this.off(eventName, eventHandler);
                    resolve();
                }, timeout);
            });
            var resultPromise = new Promise$6(function (resolve) {
            ...
            return Promise$6.race([timeoutPromise, resultPromise]);
        };
                    ...
                    switch (_a.label) {
                        case 0:
                            if (!this.contextStorage.getItem(PENDING_CHILD_WINDOW_COUNT))
                                return [2 /*return*/];
                            restoreChildWindowsPromise = new Promise$6(function (resolve) {
